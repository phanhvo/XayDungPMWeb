...
exports.createEmployee = async (data) => {
    const { manv, hotennv, gioitinh, ngsinh, sdt, email, diachi, ngaybatdaulam, chucvu, trangthai, mapb } = data;
    ...
    const result = await db.query(
        ...
        [manv, hotennv, gioitinh, ngsinh, sdt, email, diachi, ngaybatdaulam, chucvu, trangthai, mapb]
    );
    return result.rows[0];
};

exports.updateEmployee = async (manv, data) => {
    const { hotennv, gioitinh, ngsinh, sdt, email, diachi, ngaybatdaulam, chucvu, trangthai, mapb } = data;
    ...
    const result = await db.query(
        ...
        [hotennv, gioitinh, ngsinh, sdt, email, diachi, ngaybatdaulam, chucvu, trangthai, mapb, manv]
    );
